...
import { Scrollable } from '../../../scroll/scrollable/scrollable';
        ...
        render() {
            ...
            const content = _jsxs("div", {
                ...
                children: [
                    items.map((item, i)=>{
                        let start;
                        if (item.isLoading) start = _jsx(AnimatedSpinnerIcon, {
                            size: "small"
                        });
                        else if (item.start) start = item.start;
                        else if (item.icon) start = _jsx(item.icon, {
                            size: "small"
                        });
                        return _jsx("div", {
...
function AnnounceOnUpdate(props) {
    useAnnounceOnUpdate(props.message, [
        props.message
    ]);
    return null;
}
