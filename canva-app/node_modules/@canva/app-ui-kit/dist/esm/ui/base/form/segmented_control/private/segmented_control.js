    ...
    return _jsx("div", {
        ...
        children: _jsx(Grid, {
            ...
            children: options.map((option, index)=>{
                return _jsx(SegmentedControlItem, {
                    label: option.label,
