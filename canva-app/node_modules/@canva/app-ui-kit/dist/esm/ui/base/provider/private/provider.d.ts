...
export type EaselConfiguration = {
    ...
    enableButtonLoadingScan?: boolean
    expectedPixelsPerRem?: number
};
export declare function EaselProvider({ enableAnimations, direction, disableFocusTraps, enableUserSelection, theme, enableHighColorContrast, autoplayVideos, disableDialogBlur, enableButtonLoadingScan, expectedPixelsPerRem, children, }: EaselConfiguration & {
...
export declare function useEnableButtonLoadingScan(): boolean;
