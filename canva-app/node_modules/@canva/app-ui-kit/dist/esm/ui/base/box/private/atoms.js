...
import { getStyle as getColorStyle } from './color.css';
...
import gapStyles, { customProperties as gapProperties } from './gap.css';
import outlineStyles from './outline.css';
...
export function getGapClassName(gap, rowGap, columnGap) {
    if (gap || rowGap || columnGap) return gapStyles.hasGap;
}
const gapPropertyMap = {
    default: gapProperties.gap,
    smallUp: gapProperties.smallUpGap,
    mediumUp: gapProperties.mediumUpGap,
    largeUp: gapProperties.largeUpGap,
    xLargeUp: gapProperties.xLargeUpGap
};
const rowGapPropertyMap = {
    default: gapProperties.rowGap,
    smallUp: gapProperties.smallUpRowGap,
    mediumUp: gapProperties.mediumUpRowGap,
    largeUp: gapProperties.largeUpRowGap,
    xLargeUp: gapProperties.xLargeUpRowGap
};
const columnGapPropertyMap = {
    default: gapProperties.columnGap,
    smallUp: gapProperties.smallUpColumnGap,
    mediumUp: gapProperties.mediumUpColumnGap,
    largeUp: gapProperties.largeUpColumnGap,
    xLargeUp: gapProperties.xLargeUpColumnGap
};
export const getGapStyles = (gap, rowGap, columnGap)=>({
        ...(gap && generateStyle(gapPropertyMap, gap, getSpaceValue)),
        ...(rowGap && generateStyle(rowGapPropertyMap, rowGap, getSpaceValue)),
        ...(columnGap && generateStyle(columnGapPropertyMap, columnGap, getSpaceValue))
    });
...
export function hideOutlineAtom(hideOutline) {
    if (hideOutline) return outlineStyles.hideOutline;
    return null;
}
