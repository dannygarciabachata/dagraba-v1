...
import type { HeaderAndFooterProps, PopoverProps as FlyoutProps, TriggerProps, Width as FlyoutWidth } from '../../../surface/popover/popover';
...
export type BaseSelectWidth = FlyoutWidth;
...
export declare function StatelessBaseSelect<T>(props: StatelessBaseSelectProps<T>): React.JSX.Element;
export declare function BaseSelectTrigger<T>(props: BaseSelectTriggerProps<T>): React.JSX.Element;
export declare function BaseSelectMenu<T>(props: BaseSelectMenuProps<T>): React.JSX.Element;
export type WindowedSelectMenuProps<T> = BaseSelectMenuProps<T> & {
    itemHeightMultiplier?: number
};
export declare function WindowedSelectMenu<T>(props: WindowedSelectMenuProps<T>): React.JSX.Element;
export declare function renderEmptyMenuContent(): React.JSX.Element;
export declare const BaseSelectItem: typeof BaseSelectItem_;
declare function BaseSelectItem_<T>(props: BaseSelectItemProps<T>): React.JSX.Element;
export {};
