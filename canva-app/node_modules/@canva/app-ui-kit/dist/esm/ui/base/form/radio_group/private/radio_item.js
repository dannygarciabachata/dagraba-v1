...
import { WithKeyCombinationHandler } from '../../../key_combinations/key_combinations';
...
export function RadioItem(
    { label, description, className, disabled, checked, ariaLabel, name, value, onChange: _onChange, onFocus, onBlur, ref }
) {
    const formatValue = ()=>{
    ...
    React.useImperativeHandle(ref, ()=>createBasicHTMLHandle(inputRef));
    return _jsx(WithKeyCombinationHandler, {
        map: inputKeyMap,
        handleInputs: true,
        children: ({ ref: keyCombinationRef })=>_jsx(Observer, {
                children: ()=>_jsxs(_Fragment, {
                        children: [
                            _jsx("input", {
                                ...
                                onChange: onChange,
                                ref: composeRefs(inputRef, keyCombinationRef),
                                value: formatValue(),
                                disabled: disabled,
                                checked: checked,
                                name: name,
                            ...
                            _jsxs("label", {
                                ...
                                children: [
                                    _jsx("span", {
                                        "aria-hidden": true,
                                        className: classNames(styles.uiRadio, {
                                            [styles.hasLabelText]: !!label
                                        })
                                    }),
                                    _jsx(RadioItemLabel, {
                                        label: label,
