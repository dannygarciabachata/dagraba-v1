...
function NumberInput({ value: valueProp, defaultValue, onChange: onChangeProp, onChangeComplete: onChangeCompleteProp, onKeyDown: onKeyDownProp, step = 1, min, max, maximumFractionDigits, isValidCharacter: isValidCharacterProp, hasSpinButtons, decrementAriaLabel, incrementAriaLabel, ref, ...passThroughProps }) {
    ...
    const onKeyDown = _react.useCallback((e)=>{
        const selectionStart = inputRef.current?.selectionStart || undefined;
    ...
    return (0, _jsxruntime.jsx)(_base_input.BaseInput, {
        ref: (0, _compose_refs.composeRefs)(ref, inputRef),
        type: "text",
        inputMode: inputMode,
