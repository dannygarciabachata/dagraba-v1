...
export const BaseSelect = observer(function BaseSelect(props) {
    ...
    const [store] = React.useState(()=>props.store ?? new BaseSelectStore());
    const [presenter] = React.useState(()=>props.presenter ?? new BaseSelectPresenter());
    ...
    const onSelection = props.onSelection ?? defaultOnSelection;
