...
export declare const tones: readonly ["contrast", "neutral", "positive", "warn", "info", "critical", "neutralLow", "assist", "assistLow", "positiveLow", "warnLow", "infoLow", "criticalLow"];
...
export declare const SecondaryButtonBadge: (props: ButtonBadgeProps) => React.JSX.Element;
