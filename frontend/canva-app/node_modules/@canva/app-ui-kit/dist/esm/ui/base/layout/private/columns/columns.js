...
export function Column({ width = 'fluid', children, tagName: TagName = 'div', ref, ...rest }) {
    return _jsx(TagName, {
...
export function Columns(
    { children, spacing, align, alignY, height, tagName: TagName = 'div', reversed, collapseBelow, collapsed, ref, ...rest }
) {
    return (_jsx(TagName, {
