...
export function BadgeContainer(
    { children, paddingStyle = 'standard', className, ariaLabel, ariaLabelledBy, ariaDescribedBy, onMouseEnter, onMouseLeave, onMouseUp, onMouseDown, role, ref }
) {
...
export const ExtendedBadgeVisibilityTrigger = observer(({ children, tagName: TagName = 'div', role, className, onMouseEnter, onMouseLeave, onMouseUp, onMouseDown, ariaLabel, ariaLabelledBy, ariaDescribedBy, ref })=>{
    return _jsx(TagName, {
