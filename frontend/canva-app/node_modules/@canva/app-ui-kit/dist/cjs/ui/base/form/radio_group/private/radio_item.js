...
function RadioItem({ label, description, className, disabled, checked, ariaLabel, name, value, onChange: _onChange, onFocus, onBlur, ref }) {
    const formatValue = ()=>{
                ...
                children: ()=>(0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
                        children: [
                            (0, _jsxruntime.jsx)("input", {
                                ...
                                onChange: onChange,
                                ref: (0, _compose_refs.composeRefs)(inputRef, keyCombinationRef),
                                value: formatValue(),
                                disabled: disabled,
                                checked: checked,
                                name: name,
