...
const MenuItemButton = (0, _mobxreactlite.observer)(function MenuItemButton({ id, role, alignment, children, className, active, selected, pressed, disabled, draggable, disclosure, onClick, onFocus, onBlur, onMouseEnter, onMouseLeave, onContextMenu, tabIndex, start, end, label, description, lineClamp, buttonRef, tooltipLabel: tooltipLabelProp, tooltipDisabled, tooltipLineClamp, tooltipPlacement, tooltipShortcut, ariaLabel, ariaLabelledBy, ariaDescribedBy, ariaHasPopup, ariaControls, ariaSelected, ariaCurrent, href, target, download }) {
    ...
    const decoratedContent = start || end ? (0, _jsxruntime.jsxs)(_layout.Columns, {
        tagName: "span",
        alignY: "center",
        spacing: "1u",
        children: [
    ...
    if (!isButtonLike) return (0, _jsxruntime.jsx)(_box.Box, {
        id: id,
        className: (0, _classnames.default)(_menucss.default.text, buttonClassName),
        ariaLabel: ariaLabel,
...
function ToggleMenu({ id, menuId: menuIdProp, labelId: labelIdProp, label, labelNode, disabled, draggable, start, end, active, selected, buttonRef, tooltipLabel, tooltipPlacement, href, onClick, onToggleClick, onContextMenu, toggleLabel, defaultExpanded, expanded: expandedProp, buttonClassName, ref, ...props }) {
    ...
    return (0, _jsxruntime.jsxs)(_box.Box, {
        ...
        children: [
            ...
            showSeparateToggleButton && (0, _jsxruntime.jsx)(_button.Button, {
                ...
                iconSize: "small",
                icon: Icon,
                ariaLabel: toggleLabel ?? expanded ? _menumessages.MenuMessages.collapseMenu(label) : _menumessages.MenuMessages.expandMenu(label),
                disabled: disabled,
                ...toggleButtonProps
            }),
