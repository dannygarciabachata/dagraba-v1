...
function TooltipContent(props) {
    ...
    const shortcutElement = shortcut ? (0, _jsxruntime.jsx)(_shortcut.Shortcut, {
    ...
    return (0, _jsxruntime.jsx)(_theme.ThemeBoundary, {
        ...
        classicLight: "dark",
        classicDark: "dark",
        children: ({ className })=>(0, _jsxruntime.jsx)(TooltipBox, {
                className: className,
                display: "flex",
                flexDirection: "row",
                ...ariaProps,
...
function StatelessTooltip({ children, placement = 'bottom', open, arrow = true, refObj, direction, ...contentProps }) {
