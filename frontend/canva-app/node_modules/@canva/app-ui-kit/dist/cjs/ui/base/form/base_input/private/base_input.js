...
_export(exports, {
    ...
    get useOnWrapperClick () {
        return useOnWrapperClick;
    }
});
...
function getLegacyIcon({ icon, iconClassName }, position) {
    return icon?.align === position && (0, _jsxruntime.jsx)(Icon, {
        ...icon,
...
const BaseInput = (0, _mobxreactlite.observer)(function BaseInput({ ref, ...props_ }) {
