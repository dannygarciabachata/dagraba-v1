...
function withCardContextProvider(Component) {
    ...
    WithProvider.displayName = `withCardContext(${Component.displayName ?? Component.name})`;
    return WithProvider;
}
...
const useCardContext = ()=>_react.useContext(CardContext) ?? createContext();
