...
_export(exports, {
    get SUBPIXEL_ROUNDING_TOLERANCE () {
        return SUBPIXEL_ROUNDING_TOLERANCE;
    },
    get getCoreScrollState () {
        return getCoreScrollState;
    },
...
function scrollTo(container, options) {
...
function scrollBy(container, options) {
