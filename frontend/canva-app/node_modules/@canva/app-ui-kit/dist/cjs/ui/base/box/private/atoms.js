...
const _colorcss = require("./color.css");
const _displaycss = _interop_require_wildcard(require("./display.css"));
const _flexcss = _interop_require_wildcard(require("./flex.css"));
const _gapcss = _interop_require_wildcard(require("./gap.css"));
const _outlinecss = _interop_require_default(require("./outline.css"));
...
const BgFgMap = {
    ...
    ['page']: 'none',
    ['surface']: 'none',
    ['contrast']: 'feedbackOverlay',
    ['assist']: 'feedbackHint',
    ['positive']: 'feedbackPositive',
    ['info']: 'feedbackInfo',
    ['warn']: 'feedbackWarn',
    ['critical']: 'feedbackCritical',
    ['neutralLow']: 'actionSecondary',
    ['assistLow']: 'feedbackHintSubtle',
    ['positiveLow']: 'feedbackPositiveSubtle',
    ['infoLow']: 'feedbackInfoSubtle',
    ['warnLow']: 'feedbackWarnSubtle',
    ['criticalLow']: 'feedbackCriticalSubtle',
    ['checkered']: 'content',
    ['neutral']: 'content',
    ['neutralSubtle']: 'contentSubtle',
    ['elevationSurfaceSunken']: 'content',
    ['elevationSurface']: 'content',
    ['elevationSurfaceRaised']: 'content',
    ['elevationSurfaceFloating']: 'content',
    ['feedbackOverlay']: 'feedbackOverlay',
    ['feedbackHint']: 'feedbackHint',
    ['feedbackHintSubtle']: 'feedbackHintSubtle',
    ['feedbackPositive']: 'feedbackPositive',
    ['feedbackPositiveSubtle']: 'feedbackPositiveSubtle',
    ['feedbackInfo']: 'feedbackInfo',
    ['feedbackInfoSubtle']: 'feedbackInfoSubtle',
    ['feedbackWarn']: 'feedbackWarn',
    ['feedbackWarnSubtle']: 'feedbackWarnSubtle',
    ['feedbackCritical']: 'feedbackCritical',
    ['feedbackCriticalSubtle']: 'feedbackCriticalSubtle'
};
function colorAtom(color, background) {
    const effectiveColor = color ?? (background ? BgFgMap[background] : 'none');
    if (effectiveColor === 'none') return null;
    return (0, _colorcss.getStyle)(`${effectiveColor}Color`);
}
const borders = [
    'none',
    'standard',
...
function shadowAtom(shadow) {
    ...
    return (0, _shadowcss.getStyle)(shadow);
}
const sizes = [
    'unset',
    'full'
...
function getGapClassName(gap, rowGap, columnGap) {
    if (gap || rowGap || columnGap) return _gapcss.default.hasGap;
}
const gapPropertyMap = {
    default: _gapcss.customProperties.gap,
    smallUp: _gapcss.customProperties.smallUpGap,
    mediumUp: _gapcss.customProperties.mediumUpGap,
    largeUp: _gapcss.customProperties.largeUpGap,
    xLargeUp: _gapcss.customProperties.xLargeUpGap
};
const rowGapPropertyMap = {
    default: _gapcss.customProperties.rowGap,
    smallUp: _gapcss.customProperties.smallUpRowGap,
    mediumUp: _gapcss.customProperties.mediumUpRowGap,
    largeUp: _gapcss.customProperties.largeUpRowGap,
    xLargeUp: _gapcss.customProperties.xLargeUpRowGap
};
const columnGapPropertyMap = {
    default: _gapcss.customProperties.columnGap,
    smallUp: _gapcss.customProperties.smallUpColumnGap,
    mediumUp: _gapcss.customProperties.mediumUpColumnGap,
    largeUp: _gapcss.customProperties.largeUpColumnGap,
    xLargeUp: _gapcss.customProperties.xLargeUpColumnGap
};
const getGapStyles = (gap, rowGap, columnGap)=>({
        ...(gap && (0, _responsive.generateStyle)(gapPropertyMap, gap, _metrics.getSpaceValue)),
        ...(rowGap && (0, _responsive.generateStyle)(rowGapPropertyMap, rowGap, _metrics.getSpaceValue)),
        ...(columnGap && (0, _responsive.generateStyle)(columnGapPropertyMap, columnGap, _metrics.getSpaceValue))
    });
const positions = [
    'static',
    'relative',
...
function hideOutlineAtom(hideOutline) {
    if (hideOutline) return _outlinecss.default.hideOutline;
    return null;
}
