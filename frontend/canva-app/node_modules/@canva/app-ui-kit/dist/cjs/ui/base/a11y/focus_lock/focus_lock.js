...
const FocusLock = (0, _mobxreactlite.observer)(function FocusLock({ autoFocus = true, children, className, disabled: propsDisabled = false, lockProps, returnFocus = true, preventScroll = 'never', makeContainerFocusable = false, onRequestEscape, keyCombinationMap = [], handleKeysOnInputs = true, ref }) {
    ...
    (0, _use_isomorphic_layout_effect.useIsomorphicLayoutEffect)(()=>{
        const currentWindow = rootRef.current?.ownerDocument.defaultView;
    ...
    return (0, _jsxruntime.jsx)(_focus_lock_manager.FocusLockManagerContextProvider, {
        ...
        children: (0, _jsxruntime.jsxs)("div", {
            ...lockProps,
            className: className,
            ref: (0, _compose_refs.composeRefs)(rootRef, ref, keyHandlerRef),
