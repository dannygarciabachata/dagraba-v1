...
export type SearchInputMenuProps = {
    ref?: React.Ref<SearchInputMenuHandles>
    children?: any
...
} & Omit<ClearableInputProps, 'borderless' | 'inputClassName' | 'readOnly' | 'ref'>;
export declare function SearchInputMenu(props: SearchInputMenuProps): React.ReactNode;
