...
class SAOClient {
     ...
     */ static async startTraining(config) {
        ...
        const model = await __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].instrumentModel.create({
            data: {
                name: config.name,
     ...
     */ static async registerSample(data) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].instrumentSample.create({
            data: {
                name: data.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f4376e1b._.js.map