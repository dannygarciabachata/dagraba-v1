...
function Mastering() {
    ...
    const [progress, setProgress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(35);
    const [selectedSong, setSelectedSong] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('Mi Canción Nueva');
    const [metadataDNA, setMetadataDNA] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('ORIGINAL-DNA-001');
    ...
    const handleImport = ()=>{
        ...
        input.onchange = (e)=>{
            ...
            if (file) {
                // Automáticamente usamos el nombre del archivo como el "ADN" y nombre de la canción
                const cleanName = file.name.replace(/\.[^/.]+$/, "");
                setSelectedSong(cleanName);
                setMetadataDNA(`IMPORT-${Date.now().toString().slice(-4)}`);
                alert(`Canción importada y cargada en el espacio de trabajo: ${cleanName}`);
            }
        };
        input.click();
    };
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...Array(12)
                                                                            ...
                                                                            className: `w-1 h-3 rounded-full transition-all duration-300 ${i < 8 ? 'bg-green-500/80 shadow-[0_0_5px_rgba(34,197,94,0.3)]' : i < 10 ? 'bg-yellow-500/80 shadow-[0_0_5px_rgba(234,179,8,0.3)]' : i < 11 ? 'bg-red-500/80 shadow-[0_0_5px_rgba(239,68,68,0.3)]' : 'bg-white/5'}`
                                                                        }, i, false, {
                                                                            fileName: "[project]/development/Da Graba_Studio/app/[locale]/mastering/page.tsx",
                                                                            lineNumber: 269,
                                                                            columnNumber: 49
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...Array(12)
                                                                            ...
                                                                            className: `w-1 h-3 rounded-full transition-all duration-300 ${i < 7 ? 'bg-green-500/80 shadow-[0_0_5px_rgba(34,197,94,0.3)]' : i < 9 ? 'bg-yellow-500/80 shadow-[0_0_5_rgba(234,179,8,0.3)]' : i < 10 ? 'bg-red-500/50' : 'bg-white/5'}`
                                                                        }, i, false, {
                                                                            fileName: "[project]/development/Da Graba_Studio/app/[locale]/mastering/page.tsx",
                                                                            lineNumber: 285,
                                                                            columnNumber: 49
...
//# sourceMappingURL=development_Da%20Graba_Studio_d02f951b._.js.map