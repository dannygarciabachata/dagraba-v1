...
function AudioTimeline() {
    ...
    // Derive clips from tracks that have an audioUrl (stem tracks from Extraer Stems)
    // Plus keep any manually added clips via dragging
    const [manualClips, setManualClips] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const trackClips = (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        return tracks.filter((t)=>t.audioUrl).map((t, index)=>({
                id: `clip-${t.id}`,
                trackId: t.id,
                startTime: 0,
                duration: 90,
    ...
    // Merge stem-derived clips + manual clips (manual clips take priority if same id)
    const clips = (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        for (const mc of manualClips){
            const idx = allClips.findIndex((c)=>c.id === mc.id);
            if (idx >= 0) allClips[idx] = mc; // override with moved version
            else allClips.push(mc);
        }
        return allClips;
    }, [
        trackClips,
    ...
    const handleMouseMove = (e)=>{
        ...
        // Find the clip being dragged (from merged clips) and update its position in manualClips
        ...
        if (existing) {
            ...
            setManualClips((prev)=>{
                ...
                if (idx >= 0) return prev.map((c)=>c.id === draggingClip ? updated : c);
                return [
                    ...prev,
                    updated
                ];
...
//# sourceMappingURL=development_Da%20Graba_Studio_428c4028._.js.map