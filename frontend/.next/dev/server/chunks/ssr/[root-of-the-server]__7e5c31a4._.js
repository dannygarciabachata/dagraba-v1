...
class WebAudioEngine {
    ...
    getVUMeterLevel(trackId) {
        ...
        chain.analyser.getByteTimeDomainData(dataArray);
        let maxVal = 0;
        for(let i = 0; i < bufferLength; i++){
            const val = Math.abs(dataArray[i] - 128) / 128;
            if (val > maxVal) maxVal = val;
        }
        return Math.min(127, maxVal * 127 * 1.5); // Boosted for visibility
    }
    // --- Plugin System ---
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e5c31a4._.js.map