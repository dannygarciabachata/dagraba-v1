...
"[project]/development/Da Graba_Studio/app/[locale]/mastering/history/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MasteringHistory() {
    ...
    const { history, deleteFromHistory } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$store$2f$useMasteringStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMasteringStore"])();
    const [isClient, setIsClient] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [isMastered, setIsMastered] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [previewUrl, setPreviewUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
        ...
        "MasteringHistory.useEffect": ()=>{
            if (playingId) {
                const project = history.find({
                    "MasteringHistory.useEffect.project": (p)=>p.id === playingId
                }["MasteringHistory.useEffect.project"]);
                if (project) {
                    if (isMastered) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$lib$2f$audio$2f$WebAudioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].updateEQ('master-track', project.settings.eqHighpass, project.settings.eqTilt, false);
                        __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$lib$2f$audio$2f$WebAudioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].updateCompressor('master-track', project.settings.compStrength, project.settings.compAttack, project.settings.compRelease, false);
                    } else {
                        // Neutral settings for "MIX ORIGINAL"
                        __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$lib$2f$audio$2f$WebAudioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].updateEQ('master-track', 0, 0, true);
                        __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$lib$2f$audio$2f$WebAudioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].updateCompressor('master-track', 0, 0.03, 0.1, true);
                    }
                }
            }
        }
    ...
    const handleTogglePlay = async (project)=>{
        ...
        // Stop current
        audio.pause();
        const blob = await __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$lib$2f$audio$2f$AudioStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AudioStorage"].getAudio(project.id);
        if (blob) {
            ...
            const onCanPlay = async ()=>{
                try {
                    __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$lib$2f$audio$2f$WebAudioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].connectAudioElement('master-track', audio);
                    await audio.play();
                } catch (e) {
                    if (e instanceof Error && e.name !== 'AbortError') {
    ...
    const handleDelete = async (id, e)=>{
        ...
        if (confirm('¿Estás seguro de que quieres eliminar este proyecto del historial?')) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$lib$2f$audio$2f$AudioStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AudioStorage"].deleteAudio(id);
            deleteFromHistory(id);
        }
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            history.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: history.map((project)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mb-6",
                                children: playingId === project.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(MasteringHistory, "ynohXphGpMAHsISLXWop/+iMzow=", false, function() {
    return [
...
_c = MasteringHistory;
var _c;
__turbopack_context__.k.register(_c, "MasteringHistory");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=development_Da%20Graba_Studio_036d1c7b._.js.map