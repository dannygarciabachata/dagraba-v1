...
"[project]/development/Da Graba_Studio/app/api/ai/get-dna/[genre]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    try {
        ...
        const goldStandard = await __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].masteringDNA.findFirst({
            where: {
                genre: genre,
                isGoldStandard: true
            },
        ...
        if (!goldStandard) {
            ...
            const latest = await __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].masteringDNA.findFirst({
                where: {
                    genre: genre
                },
                orderBy: {
            ...
            if (!latest) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$development$2f$Da__Graba_Studio$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
                    error: 'No DNA profile found for this genre'
                }, {
                    status: 404
                });
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__38ddb629._.js.map